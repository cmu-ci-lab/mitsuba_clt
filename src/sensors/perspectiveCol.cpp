//
// Created by Jiatian Sun on 2019-01-05.
//
...
/*!\plugin{perspectiveCol}{Perspective pinhole camera}
 * \order{1}
 * \parameters{
 ...
 */
  ...
  class PerspectiveColCameraImpl : public PerspectiveCamera {
  public:
    PerspectiveColCameraImpl(const Properties &props)
    ...
    PerspectiveColCameraImpl(Stream *stream, InstanceManager *manager)
...
//		std::cout<<str<<endl;
  ...
  MTS_IMPLEMENT_CLASS_S(PerspectiveColCameraImpl, false, PerspectiveCamera)
  MTS_EXPORT_PLUGIN(PerspectiveColCameraImpl, "Column Probing Perspective camera");
MTS_NAMESPACE_END
