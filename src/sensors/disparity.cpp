...
MTS_NAMESPACE_BEGIN
  ...
  class DisparityPerspective : public PerspectiveCamera {
  public:
    DisparityPerspective(const Properties &props)
    ...
    DisparityPerspective(Stream *stream, InstanceManager *manager)
...
//      return Spectrum(importance(trafo.inverse()(dRec.d)));
  ...
  MTS_IMPLEMENT_CLASS_S(DisparityPerspective, false, PerspectiveCamera)
  MTS_EXPORT_PLUGIN(DisparityPerspective, "Disparity Perspective");
MTS_NAMESPACE_END
