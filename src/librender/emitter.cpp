...
bool AbstractEmitter::getSamplePosition(const PositionSamplingRecord &pRec,
...
void AbstractEmitter::configureProbe(Stream *stream) const{
...
//bool Emitter::getSamplePosition(const PositionSamplingRecord &pRec,
//																 const DirectionSamplingRecord &dRec, Point2 &samplePosition) const {
//	Log(EError, "%s::getSamplePosition(const PositionSamplingRecord &, "
//								"const DirectionSamplingRecord &, Point2&) is not implemented!",
//								getClass()->getName().c_str());
...
void ProjectiveEmitter::configureProbe(Stream *stream) const{
...
void PerspectiveEmitter::configureProbe(Stream *stream) const{
